...
const Library: React.FC<LibraryProps> = ({ onSelectSong, likedSongs }) => {
  ...
  const handleArtistClick = (artistName: string) => {
    // Quick shortcut: play the artist's first song
  ...
  const handleActivityClick = (activity: any) => {
    // If activity has cover, let's try to play the corresponding song if it matches
      ...
      <section className="library-hero">
        <div className="library-avatar-wrapper">
          <img 
            ...
            alt="Wolfgang Mozart reimagined" 
          />
      ...
      <div className="bento-grid">
        ...
        <div className="bento-col-artists glass-card p-6 rounded-2xl">
          <div className="flex justify-between items-center" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            ...
            <button className="clear-search-btn" onClick={() => navigate('/search')}>View all</button>
          </div>
